...
class Generator(nn.Module):
    ...
    def forward(self,source_img,source_parse,source_all_mask,ref_img,ref_parse,ref_all_mask):
        ...
        #print(source_semantic_f.shape,ref_semantic_f.shape,ref_makeup.shape) #torch.Size([1, 64, 72, 72]) torch.Size([1, 64, 72, 72]) torch.Size([1, 3, 71, 71])
...
class Attention(nn.Module):
    ...
    def cal_correlation(self, fa, fb, alpha):
        ...
        # Debugging prints
        # print(f"fa shape after conv: {fa.shape}")  # torch.Size([1, 16, 5184])
        # print(f"fb shape after conv: {fb.shape}")  # torch.Size([1, 16, 5184])
    ...
    def forward(self, fa_raw, fb_raw, fc_raw):
        ...
        # Debugging prints
        # print(f"fc_raw shape before bmm: {fc_raw.shape}") # torch.Size([1, 3, 71, 71])
        # print(f"corr_ab_T shape before bmm: {corr_ab_T.shape}")#torch.Size([1, 16, 5184])
